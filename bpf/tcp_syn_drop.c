/**
 *	Tempesta xFW TCP SYN flood protection module
 *
 * SPDX-FileCopyrightText: © 2026 Tempesta Technologies, Inc.
 * SPDX-License-Identifier: GPL-2.0-or-later
 */
#define BPF_PROGRAM
#define XFW_TCP_SYN_DROP
#define BANNER "tcp_syn_drop"
...
xfw_process_pending(uint64_t hash, XfwSynPending *entry, uint64_t now,
		    const XfwRulesCfgTcpSynDrop *cfg)
{
	if (entry->blocked)
		return false;
