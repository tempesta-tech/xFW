...
/* Map: xfw_l2_hdr_miss */
#define MAP_L2_HDR_MISS_BASENAME      l2_hdr_miss
#define MAP_L2_HDR_MISS_REF           REGULAR_MAP_REF(MAP_L2_HDR_MISS_BASENAME)
#define MAP_L2_HDR_MISS_STR           REGULAR_MAP_STR(MAP_L2_HDR_MISS_BASENAME)
CHECK_MAP_NAME_LEN(MAP_L2_HDR_MISS_STR)
