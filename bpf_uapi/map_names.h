...
enum {
	XFW_XDP_PROG_TCP_SYN_DROP_FILTER = 0,
	XFW_XDP_PROG_TCP_SYNCOOKIES_FILTER = 1,
	XFW_XDP_PROG_DST_FILTER = 2,
	XFW_XDP_PROG_MAX
};

enum {
	XFW_TC_PROG_DST_FILTER = 0,
	XFW_TC_PROG_MAX
};
...
#define MAP_XDP_PROG_ARRAY_BASENAME	xdp_p_arr
#define MAP_XDP_PROG_ARRAY_REF		REGULAR_MAP_REF(MAP_XDP_PROG_ARRAY_BASENAME)
#define MAP_XDP_PROG_ARRAY_STR		REGULAR_MAP_STR(MAP_XDP_PROG_ARRAY_BASENAME)
CHECK_MAP_NAME_LEN(MAP_XDP_PROG_ARRAY_STR)

#define MAP_TC_PROG_ARRAY_BASENAME	tc_p_arr
#define MAP_TC_PROG_ARRAY_REF		REGULAR_MAP_REF(MAP_TC_PROG_ARRAY_BASENAME)
#define MAP_TC_PROG_ARRAY_STR		REGULAR_MAP_STR(MAP_TC_PROG_ARRAY_BASENAME)
CHECK_MAP_NAME_LEN(MAP_TC_PROG_ARRAY_STR)
