...
/* Shadow maps: xfw_0_dst_4_udp, xfw_1_dst_4_udp */
#define MAP_DST_4_UDP_BASENAME		dst_4_udp
#define MAP_DST_4_UDP_REF(idx)		SHADOW_MAP_REF(MAP_DST_4_UDP_BASENAME, idx)
#define MAP_DST_4_UDP_STR(idx)		SHADOW_MAP_STR(MAP_DST_4_UDP_BASENAME, idx)
CHECK_MAP_NAME_LEN(MAP_DST_4_UDP_STR(MAP_PRIMARY_IDX))
CHECK_MAP_NAME_LEN(MAP_DST_4_UDP_STR(MAP_SECONDARY_IDX))

/* Shadow maps: xfw_0_dst_4_tcp, xfw_1_dst_4_tcp */
#define MAP_DST_4_TCP_BASENAME		dst_4_tcp
#define MAP_DST_4_TCP_REF(idx)		SHADOW_MAP_REF(MAP_DST_4_TCP_BASENAME, idx)
#define MAP_DST_4_TCP_STR(idx)		SHADOW_MAP_STR(MAP_DST_4_TCP_BASENAME, idx)
CHECK_MAP_NAME_LEN(MAP_DST_4_TCP_STR(MAP_PRIMARY_IDX))
CHECK_MAP_NAME_LEN(MAP_DST_4_TCP_STR(MAP_SECONDARY_IDX))

/* Shadow maps: xfw_0_dst_6_udp, xfw_1_dst_6_udp */
#define MAP_DST_6_UDP_BASENAME		dst_6_udp
#define MAP_DST_6_UDP_REF(idx)		SHADOW_MAP_REF(MAP_DST_6_UDP_BASENAME, idx)
#define MAP_DST_6_UDP_STR(idx)		SHADOW_MAP_STR(MAP_DST_6_UDP_BASENAME, idx)
CHECK_MAP_NAME_LEN(MAP_DST_6_UDP_STR(MAP_PRIMARY_IDX))
CHECK_MAP_NAME_LEN(MAP_DST_6_UDP_STR(MAP_SECONDARY_IDX))

/* Shadow maps: xfw_0_dst_6_tcp, xfw_1_dst_6_tcp */
#define MAP_DST_6_TCP_BASENAME		dst_6_tcp
#define MAP_DST_6_TCP_REF(idx)		SHADOW_MAP_REF(MAP_DST_6_TCP_BASENAME, idx)
#define MAP_DST_6_TCP_STR(idx)		SHADOW_MAP_STR(MAP_DST_6_TCP_BASENAME, idx)
CHECK_MAP_NAME_LEN(MAP_DST_6_TCP_STR(MAP_PRIMARY_IDX))
CHECK_MAP_NAME_LEN(MAP_DST_6_TCP_STR(MAP_SECONDARY_IDX))
